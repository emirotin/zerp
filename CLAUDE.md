...
- `pnpm exec zerp verify <deck> --theme both --size 1280x720` — headless-browser checks for exactly one active/visible full-size frame per slide. Requires Chrome or Chromium.
